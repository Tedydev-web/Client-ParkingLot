...
- [If you have ideas for how we could improve this readme or the project in general, let us know or contribute some!](#if-you-have-ideas-for-how-we-could-improve-this-readme-or-the-project-in-general-let-us-know-or-contribute-some)
...
--------------------------------------------------------------------------------------------------------------------------------
 Build dùng node 20.12.0:
  - npm i --legacy-peer-deps
  - Nếu chạy run dev lỗi: Error: error:0308010C:digital envelope routines::unsupported
    + Chạy: export NODE_OPTIONS=--openssl-legacy-provider rồi chạy lại
--------------------------------------------------------------------------------------------------------------------------------

docker tag 41b84ab6e7d27e57d1141d661b2d2fc106bfcd487a96b9d3045cf72c5426d494 goongcmc.azurecr.io/live-map:202408261000

docker push goongcmc.azurecr.io/live-map:202408261000# Client-ParkingLot
